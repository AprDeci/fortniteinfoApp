...
<template>
 <van-nav-bar style="z-index: 1999; position: fixed " :title="nn" fixed placeholder/>


<router-view to="shop"></router-view>
<van-back-top right="10vw" bottom="10vh" />

<van-tabbar style="z-index: 1999; position: fixed " route v-model="active" placeholder fixed=true>
